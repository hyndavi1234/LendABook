...
$query = "select * from BookData where UserEmail='$email' ";
        ...
        <div class="card-block ml-3">
            ...
            <a href="ViewBook.php?id=<?php echo $row['id'];?>"  
               class="btn btn-primary mr-4" hspace="100px">
                <span class="glyphicon glyphicon-eye-open"></span>View Book</a>
            <a href="DeleteMyBook.php?id=<?php echo $row['id'];?>"  
               class="btn btn-danger mr-4" hspace="100px">
